              ...
              <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="usertype" id="edit_userype" class="form-control" style="margin-left:10px;width: 400px;float:left">
                            ...
                            <option value="manager" <?php if($udata['usertype']=='manager') echo 'selected';?>>Manager</option>
                            <option value="staff" <?php if($udata['usertype']=='staff') echo 'selected';?>>Staff</option>
                            <option value="guest" <?php if($udata['usertype']=='guest') echo 'selected';?>>Guest</option>
                        </select>
                      </div>
                    </div>
