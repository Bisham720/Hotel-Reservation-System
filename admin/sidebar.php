...
<aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">H.R.S</h5>
                  <p class="centered"> Administator Dashboard</p>
                   <li class="sub-menu">
                  ...
                  <li class="mt">
                      <a <?php if($page=="manageguest.php") echo "class='active'";?> href="manageguest.php">
                          <i class="glyphicon glyphicon-list-alt"></i>
                          <span>Manage Guest</span>
                      </a>
                  </li>
